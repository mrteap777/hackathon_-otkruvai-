...
exports.SkillsModule = SkillsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([project_model_1.SkillsSprav])],
        providers: [project_service_1.SkillsService],
        controllers: [project_controller_1.SkillsController],
    })
], SkillsModule);
